...
import DashboardPie from "./AdminDashPie";
    ...
    <div className="bg-white shadow rounded-lg p-6 mb-8">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-[#2A4F8F] hover:bg-[#1E365E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2A4F8F]"
        >
          + Add New Branch
        </button>
      </div>
        ...
        <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 pl-3 pr-10 py-2 text-sm border-gray-300 focus:outline-none focus:ring-[#2A4F8F] focus:border-[#1E365E] rounded-md shadow-sm"
            />
            <button
              onClick={handleAddBranch}
              className="px-4 py-2 bg-[#1E365E] text-white rounded-md hover:bg-[#2A4F8F] focus:outline-none focus:ring-2 focus:ring-[#9FC0AE] focus:ring-offset-2 shadow-sm"
            >
              Add Branch
            </button>
          </div>
  ...
  const dashboardCards = [
    {
      ...
      bgColor:
        "bg-[#2A4F8F] text-white hover:shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out",
    },
    {
      ...
      bgColor:
        "bg-[#2A4F8F] text-white  border border-gray-300 hover:shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out",
    },
    {
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                View and manage upcoming exam schedule
              </p>
            </div>
            <button
              onClick={() => navigate(`/admin/timetable/${selectedBranch}`)}
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#2A4F8F] hover:bg-[#1E365E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2A4F8F]"
            >
              View All
            </button>
          </div>
